import delimited "/Users/sepinetam/Documents/Stata/projs/eme/src/dta/01t.csv", encoding("gbk") clear
...
// twoway (scatter IM_P IM_Q if year == 2019, ///
//             msymbol(circle) mcolor(blue) ///
//             legend(label(1 "2019"))) ///
//        (scatter IM_P IM_Q if year == 2020, ///
//             msymbol(circle) mcolor(red) ////
//             legend(label(2 "2020"))) ///
//        (scatter IM_P IM_Q if year == 2021, ///
//             msymbol(circle) mcolor(green) ///
//             legend(label(3 "2021"))) ///
//        (scatter IM_P IM_Q if year == 2022, ///
//             msymbol(circle) mcolor(purple) ///
//             legend(label(4 "2022"))) ///
// 	   (scatter IM_P IM_Q if year == 2023, ///
//             msymbol(circle) mcolor(black) ///
//             legend(label(5 "2023"))), ///
//     title("Scatter Plot of IM_P vs IM_Q (2019-2023)") ///
...
// reg log(IM_P) log(IM_Q)
gen logimp = log(IM_P)
gen logimq = log(IM_Q)

reg logimp logimq

scatter logimp logimq
